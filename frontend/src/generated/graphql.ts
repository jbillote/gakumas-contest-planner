...
export const PCardsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PCards' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'customCharacter' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<PCardsQuery, PCardsQueryVariables>
