...
async function main() {
  ...
  const supportResult = await prisma.$executeRaw`INSERT INTO "PCard" ("id", "filename", "name", "type", "plan", "rarity", "cost", "customCharacter") VALUES
    (500, "img_general_skillcard_sup-2_025", "お姉ちゃんだもの！", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_026", "おアツイ視線", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_027", "ご指導ご鞭撻", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_028", "ストレッチ談義", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_029", "全力サポート", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_092", "旬の味わい", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_087", "キメ顔で自撮り", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_088", "切れた鼻緒が結んだ絆", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_090", "気になる……", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_086", "なに聴いてるの？", "ACTIVE", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_091", "こうかい……？", "ACTIVE", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_094", "ディテールが肝心", "ACTIVE", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_095", "草笛ハーモニー", "MENTAL", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_093", "愛情レインボー", "MENTAL", "ANOMALY", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-2_096", "小さなお客さん", "ACTIVE", "ANOMALY", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_024", "花萌ゆ季節", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_025", "陽だまりの生徒会室", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_026", "心のアルバム", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_027", "ティーパーティ", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_046", "光のステージ", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_048", "新生徒会爆誕！", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_037", "薄れゆく壁", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_088", "みずたまりスキップ", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_093", "紅葉ランニング", "MENTAL", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_125", "勝負はこれから！", "ACTIVE", "FREE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_047", "喧嘩するほど仲がいい", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_090", "はじける水しぶき", "ACTIVE", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_091", "交わる感情", "ACTIVE", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_095", "光の夜", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_109", "練習再開！", "MENTAL", "SENSE", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_023", "ダメダメクッキング", "MENTAL", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_089", "お泊り猛勉強", "MENTAL", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_092", "その本、おもしろい？", "ACTIVE", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_094", "ほかほか焼き芋", "MENTAL", "LOGIC", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_121", "雨宿りのバス停", "MENTAL", "ANOMALY", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_124", "バレンタイン大作戦！", "MENTAL", "ANOMALY", "SUPPORT", null, false),
    (null, "img_general_skillcard_sup-3_126", "対戦お願いします！", "MENTAL", "ANOMALY", "SUPPORT", null, false)`
